...
type HeadlessOutput struct {
	...
	DVHOPCPUPct           float64              `json:"dvhop_cpu_pct" yaml:"dvhop_cpu_pct" xml:"DVHOPCPUPct" toon:"dvhop_cpu_pct"`
	GUMERMBs              float64              `json:"gumer_mb_per_s" yaml:"gumer_mb_per_s" xml:"GUMERMBs" toon:"gumer_mb_per_s"`
	CCTCDeltaC            float64              `json:"cctc_delta_celsius" yaml:"cctc_delta_celsius" xml:"CCTCDeltaC" toon:"cctc_delta_celsius"`
}
...
func collectHeadlessData(tbInfo *ThunderboltOutput, sysInfo SystemInfo) HeadlessOutput {
	...
	CollectCCTC(chipLabel, float64(m.CPUTemp))
	// ─────────────────────────────────────────────────────────────────────────
	...
	output := HeadlessOutput{
		...
		DVHOPCPUPct:           getDVHOPValue(chipLabel),
		GUMERMBs:              getGUMERValue(chipLabel),
		CCTCDeltaC:            getCCTCValue(chipLabel),
	}
