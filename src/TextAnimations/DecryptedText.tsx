// Sourced from react-bits (DavidHDev/react-bits, ts-tailwind variant). The upstream file
// wraps its output in a framer-motion span; that package is intentionally not a dependency
// here, and the decrypt animation is driven entirely by setInterval/state — so the wrapper
// is a plain <span>. No behavioural change.
